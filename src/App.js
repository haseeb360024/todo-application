  ...
  return(
   ...
   <div className="flex flex-col items-center text-green-900">
    ...
    <div className="p-6">
      ...
      />
      <button onClick={addTasks} className="bg-blue-400 text-white p-3 m-3 rounded-md font-bold hover:bg-blue-600">Add Task</button>
    </div>
    <div>
       { tasks?.length > 0 ? (
        <ul>
        ...
        <div>
          ...
          <img width={"300px"} src="https://assets-v2.lottiefiles.com/a/435a7e80-1153-11ee-a46f-7f1c0e4a511a/ePxvZATa5E.gif" alt="" />
